...
// ---------------------------------------------------------------------------
reg [31:0] num_tests;
reg [31:0] test_indices [0:160];   // 1 count + 80 tests x 2 (index, label) = 161 entries
reg [7:0]  expected_labels [0:79];
...
reg [31:0] passed_mnist_idx [0:79];
reg [31:0] failed_mnist_idx [0:79];
